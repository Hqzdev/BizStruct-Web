...
const YourWorkInSync: React.FC<YourWorkInSyncProps> = ({
  ...
  const imgFrame2147223206 = "/favicon.ico"
  ...
  return (
    <div
      ...
      role="img"
      aria-label="Telegram bot conversation showing task creation and Notion sync"
    >
        ...
        <div style={{ width: "356px", height: "216px", position: "relative", transform: "scale(1.1)" }}>
          ...
          >
            ...
            >
              ...
              >
                /task Review Q4 report by Friday
              </span>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              >
                Daily Summary: 3 tasks, 2 projects
              </span>
            </div>
            {/* Send button */}
            <div
